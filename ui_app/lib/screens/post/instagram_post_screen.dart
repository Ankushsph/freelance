...
class InstagramPostScreen extends StatefulWidget {
  ...
  const InstagramPostScreen({super.key, this.preSelectedDate});
    ...
    return Container(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          icon: Icon(icon, size: 20, color: const Color(0xFFE4405F)),
          hintText: hint,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Row(
          children: [
            Image.asset('assets/images/social/ig.png', width: 24, height: 24),
            const SizedBox(width: 8),
            const Text("Instagram Post"),
          ],
        ),
      ),
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          color: const Color(0xFFE4405F).withOpacity(.05),
                        ),
                        child: Row(
                          children: [
                            const Icon(Icons.schedule, color: Color(0xFFE4405F)),
                            ...
                            Expanded(
                              child: Text(
                                ...
                                style: const TextStyle(color: Color(0xFFE4405F), fontWeight: FontWeight.w500),
                              ),
                            ),
