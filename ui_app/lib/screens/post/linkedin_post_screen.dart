...
class LinkedInPostScreen extends StatefulWidget {
  ...
  const LinkedInPostScreen({super.key, this.preSelectedDate});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Row(
          children: [
            Image.asset('assets/images/social/linkedin.png', width: 24, height: 24),
            const SizedBox(width: 8),
            const Text("LinkedIn Post"),
          ],
        ),
      ),
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(color: const Color(0xFF0A66C2)),
                          color: const Color(0xFF0A66C2).withOpacity(.05),
                        ),
                        child: Row(
                          children: [
                            const Icon(Icons.schedule, color: Color(0xFF0A66C2)),
                            ...
                            Expanded(
                              child: Text(
                                ...
                                style: const TextStyle(color: Color(0xFF0A66C2), fontWeight: FontWeight.w500),
                              ),
                            ),
