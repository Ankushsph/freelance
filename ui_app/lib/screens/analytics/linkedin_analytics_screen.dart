...
import 'widgets/linkedin_content_analytics_sheet.dart';
...
class _LinkedInAnalyticsScreenState extends State<LinkedInAnalyticsScreen> {
  ...
  List<Map<String, dynamic>> _getSamplePosts() {
    return [
      {
        'id': '1',
        'caption': 'Professional insights on leadership',
      ...
      {
        'id': '2',
        'caption': 'Industry trends for 2026',
      ...
      {
        'id': '3',
        'caption': 'Career development tips',
    ...
    switch (selectedTab) {
      case 'Reach':
        return {
          ...
          'current': 520,
          'previous': 440,
          'currentData': [400.0, 450.0, 480.0, 460.0, 490.0, 500.0, 520.0],
          'previousData': [380.0, 400.0, 390.0, 410.0, 420.0, 430.0, 440.0],
        };
      case 'Followers':
        return {
          'title': 'New Followers',
          'current': 85,
          'previous': 240,
          'currentData': [60.0, 70.0, 75.0, 70.0, 80.0, 82.0, 85.0],
          'previousData': [220.0, 225.0, 230.0, 228.0, 235.0, 238.0, 240.0],
        };
      case 'Content interaction':
        return {
          ...
          'current': 180,
          'previous': 242,
          'currentData': [150.0, 160.0, 165.0, 170.0, 175.0, 178.0, 180.0],
          'previousData': [220.0, 225.0, 230.0, 228.0, 235.0, 240.0, 242.0],
        };
      case 'Link clicks':
        return {
          'title': 'New Clicks',
          'current': 45,
          'previous': 240,
          'currentData': [30.0, 35.0, 38.0, 40.0, 42.0, 43.0, 45.0],
          'previousData': [220.0, 225.0, 230.0, 228.0, 235.0, 238.0, 240.0],
        };
      default:
        return {
          ...
          return Padding(
            ...
            child: GestureDetector(
              ...
              child: Container(
                padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 8),
                decoration: BoxDecoration(
                  color: isSelected ? const Color(0xFF0A66C2) : Colors.transparent,
                  border: Border.all(
                    color: isSelected ? const Color(0xFF0A66C2) : Colors.grey.shade400,
                  ),
                  borderRadius: BorderRadius.circular(20),
                ),
                child: Text(
                ...
                return GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: (isStart || isEnd) ? Border.all(color: const Color(0xFF0A66C2), width: 2) : null,
                    ),
                    child: Center(
                      child: Text(
                        dayNumber.toString(),
  ...
  Widget _buildContentSection() {
    final contentTypes = ['Posts', 'Articles', 'Videos'];
    ...
    return GestureDetector(
      onTap: () {
        showModalBottomSheet(
          ...
          builder: (context) => LinkedInContentAnalyticsSheet(post: post),
        );
      },
      child: Container(
          ...
          children: [
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  Text(
                    post['caption'] ?? 'Professional insights',
                    style: const TextStyle(
                      fontSize: 15,
                      fontWeight: FontWeight.w600,
                    ),
